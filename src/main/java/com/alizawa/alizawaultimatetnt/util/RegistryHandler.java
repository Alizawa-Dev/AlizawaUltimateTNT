...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> ALIZAWA_HEAD_BLOCK = BLOCKS.register("alizawa_head_block", () -> new TNTBlock(AbstractBlock.Properties.of(Material.EXPLOSIVE).instabreak().lightLevel(value -> 50).strength(1.0F, 100.0F)
