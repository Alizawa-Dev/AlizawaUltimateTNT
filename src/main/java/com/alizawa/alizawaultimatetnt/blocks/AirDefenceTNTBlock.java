...
public class AirDefenceTNTBlock extends TNTBlock {
    public AirDefenceTNTBlock(Properties properties) {
    ...
    public void catchFire(BlockState state, World world, BlockPos pos, Direction direction, @Nullable LivingEntity igniter){
        if (!world.isClientSide()) {
            AirDefenceTNTEntity entity = new AirDefenceTNTEntity(RegistryHandler.AIR_DEFENCE_TNT_ENTITY.get(), world);
